<template>
    <div class="container-fluid p-0 pout">
        ...
        <div @click="gengduo()" class="imgwidth" style="width:200px;padding:0px;border-right:0px">
            <!-- <router-link to="/home"><img style="hight:100%" src="img/home/header/logo.png" alt=""></router-link> -->
            <router-link to="/"><img style="hight:100%" src="../../../public/img/home/header/logo.png" alt=""></router-link>
        </div>
        ...
        <div @click="gengduo()">
            <router-link to="/product">
            <img src="../../../public/img/home/header/dangao.png" alt=""><br>
            <p class="outp">蛋糕</p>
            </router-link><br>
        </div>
        <div @click="gengduo()">
    ...
    <div class="adress" >
        ...
        <p  class="active adresserp2" >{{addr}}</p>
        </div>
        <div>
            <ul class="adresserul">
                <li @click="addrs(k)"  class="adresserli" v-for="(i,k) of address" :key="k" >{{address[k].address}}</li>
            </ul>
        </div>
    </div>
    </div>
    ...
    <div class="denglul"  v-show="denglushow">
        <div class="dengluldiv">
            ...
            <tr >
                <td class="tdright tdfontsize trpadding"><a href=""><img  src="../../../public/img/home/header/zhifubao.png" alt=""></a></td>
        ...
        <table v-else>
            ...
            <tr>
                <td colspan="2" class="tdinput"><input v-model="pusername" :state="puserunamestate" @blur="checkUsername()"  type="text" name="zcuname" placeholder="设置用户名" :disabled="isAgree!==true"></td>
                <!-- <td></td> -->
            </tr>
            <tr>
                <td colspan="2" class="tdinput"><input v-model="ppassword" :state="ppasswordState"  @blur="checkPassword()" type="password" name="zcupwd" placeholder="密码(6-20位字符)" :disabled="isAgree!==true"></td>
        <!-- <td></td> -->
            </tr>
            <tr>
                <td colspan="2" class="tdinput"><input v-model="ppassword2" :state="ppassword2State"  @blur="checkConPassword()" type="password" name="upwd2" placeholder="再次输入密码" :disabled="isAgree!==true"></td>
                <!-- <td></td> -->
            </tr>
            <tr>
            ...
            <tr>
                <td  colspan="2" class=" zhucetd yiyouzhanghao tdinput " @click="tongyi()"><span  class="borderr" style="margin-top:-4px" v-if="istongyi"></span><span v-else class="borderr2" style="margin-top:-4px"></span> 《MCAKE购物协议》</td>
                <!-- <td class=""></td> -->
    ...
    <!-- 点击显示购物车 -->
    <!-- 外面的大div -->
    <div class="gouwuchediv" v-show="gouwucheshow">
        <!-- 里面的div -->
        <div class="gouwuchedivsm">
            <!-- 上面的div -->
            <div class="gouwuche">
                <span @click="gouwucheshanchu()" class="gouwucheshanchu">x</span>
                <span class="spanborder"></span>
                <span class="gouwucheshuliang"><a class="gouwucheshulianga">0</a></span>
                <img src="../../../public/img/home/header/bag.png" alt="">
                <span class="gouwuspan">Shopping cart</span>
            </div>
            <!-- 中间的div储存购物车物品 -->
            <div class="gouwuchewp">
                <!-- 还没有写 -->
            </div>
            <!-- 合计部分 -->
            <div class="gouwuheji">
                <span class="gouwuhejispan1">合计：</span><span class="gouwuhejispan2">¥ 2304.00</span><br>
                <span class="gouwuhejispan3">n件商品</span><span class="gouwuhejispan4">运费：¥ 0.00</span>
            </div>
            <!-- 两个按钮 -->
            <div class="gouwuchedivbt">
                <button class="gouwuchebt1">进入购物车</button>
                <button class="gouwuchebt2">去结算</button>
            </div>
        </div>
    </div>
    </div> 
...
export default {
    ...
    checkConPassword(){
      ...
      if(this.checkUsername() && this.checkPassword() && this.checkConPassword()){
          ...
          this.axios.post('/user/register','username='+this.pusername+'&password='+this.ppassword).then(res=>{//res才是服务器返回的信息
            if(res.data.code==0){
              //注册失败
